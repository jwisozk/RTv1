...
/*   Updated: 2019/09/26 12:09:07 by iplastun         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//
//
//	l1 = ft_create_light("ambient", 0.2, ft_create_vec3(0, 0, 0));
//	l2 = ft_create_light("point", 0.7, ft_create_vec3(1, 0, 0));
//	l3 = ft_create_light("directional", 0.0, ft_create_vec3(1, 0, 0));
...
void ft_get_scene(int fd, t_data *data)
{
	...
	while (get_next_line(fd, &line) > 0)
	{
		...
		else if ((str = ft_strsplit(line, ' '))[0] != NULL)
		{
			j = 0;
			while (str[j] != NULL)
				j++;
